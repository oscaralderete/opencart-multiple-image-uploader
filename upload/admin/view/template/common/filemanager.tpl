	...
	<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					<div class="col-sm-5"><a href="<?php echo $parent; ?>" data-toggle="tooltip" title="<?php echo $button_parent; ?>" id="button-parent" class="btn btn-default"><i class="fa fa-level-up"></i></a> <a href="<?php echo $refresh; ?>" data-toggle="tooltip" title="<?php echo $button_refresh; ?>" id="button-refresh" class="btn btn-default"><i class="fa fa-refresh"></i></a>
						...
						<button type="button" data-toggle="tooltip" title="Multiple uploads" id="button-multiupload" class="btn btn-primary"><span class="glyphicon glyphicon-th-list" aria-hidden="true"></span></button>
					</div>
					<div class="col-sm-7">
		...
		<div id="draggable" style="display:none">
			<div class="oa-modal-body" style="padding:15px">
				...
				<br>
				<button type="button" data-toggle="tooltip" title="Cancel multiple uploads" id="button-calcel-multiupload" class="btn btn-primary"><span class="glyphicon glyphicon-remove" aria-hidden="true"></span></button>
			</div>
		</div>
	</div>
</div>
